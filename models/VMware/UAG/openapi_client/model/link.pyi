...
class Link(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["href", "params", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["href", "params", ], str]):
