...
class AirWatchTunnelServerEdgeServiceSettings(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class configuredService(
                        ...
                        class MetaOapg:
                            enum_value_to_name = {
                                "WEB_REVERSE_PROXY": "WEB_REVERSE_PROXY",
                                "VIEW": "VIEW",
                                "TUNNEL_GATEWAY": "TUNNEL_GATEWAY",
                                "TUNNEL_PROXY": "TUNNEL_PROXY",
                                "SEG": "SEG",
                                "CONTENT_GATEWAY": "CONTENT_GATEWAY",
                                "TUNNEL_GATEWAY_AND_TUNNEL_PROXY": "TUNNEL_GATEWAY_AND_TUNNEL_PROXY",
                                "DUMMY_TYPE": "DUMMY_TYPE",
                            }
                        
                        @schemas.classproperty
                        def WEB_REVERSE_PROXY(cls):
                            return cls("WEB_REVERSE_PROXY")
                        ...
                        @schemas.classproperty
                        def TUNNEL_GATEWAY(cls):
                            return cls("TUNNEL_GATEWAY")
                        
                        @schemas.classproperty
                        def TUNNEL_PROXY(cls):
                            return cls("TUNNEL_PROXY")
                        ...
                        @schemas.classproperty
                        def CONTENT_GATEWAY(cls):
                            return cls("CONTENT_GATEWAY")
                        
                        @schemas.classproperty
                        def TUNNEL_GATEWAY_AND_TUNNEL_PROXY(cls):
                            return cls("TUNNEL_GATEWAY_AND_TUNNEL_PROXY")
                        
                        @schemas.classproperty
                        def DUMMY_TYPE(cls):
                            return cls("DUMMY_TYPE")
                    __annotations__ = {
            ...
            configuredService: MetaOapg.properties.configuredService
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["configuredService"]) -> MetaOapg.properties.configuredService: ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["apiServerUrl", "apiServerUsername", "apiServerPassword", "organizationGroupCode", "airwatchServerHostname", "reinitializeGatewayProcess", "outboundProxyHost", "outboundProxyPort", "outboundProxyUsername", "ntlmAuthentication", "outboundProxyPassword", "airwatchOutboundProxy", "airwatchComponentsInstalled", "airwatchAgentStartUpMode", "serviceHost", "servicePort", "serviceStatsPort", "serviceName", "serviceInstallStatus", "serviceInstallationMessage", "runningMode", "serviceConfigurationFailed", "configuredService", ], str]):
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["configuredService"]) -> MetaOapg.properties.configuredService: ...
            ...
            def __new__(
                ...
                *_args: typing.Union[dict, frozendict.frozendict, ],
                ...
                configuredService: typing.Union[MetaOapg.properties.configuredService, str, ],
