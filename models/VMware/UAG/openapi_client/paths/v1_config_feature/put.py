...
# body param
SchemaForRequestBodyApplicationJson = UAGFeatureFlagInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_feature_settings_oapg(
        self,
...
class UpdateFeatureSettings(BaseApi):
    ...
    def update_feature_settings(
        ...
        return self._update_feature_settings_oapg(
            body=body,
