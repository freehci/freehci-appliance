...
# body param
SchemaForRequestBodyApplicationJson = SyslogServerSettings
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_syslog_server_settings_oapg(
        self,
...
class UpdateSyslogServerSettings(BaseApi):
    ...
    def update_syslog_server_settings(
        ...
        return self._update_syslog_server_settings_oapg(
            body=body,
