<a name="__pageTop"></a>
# openapi_client.apis.tags.jwt_issuer_settings_api.JWTIssuerSettingsApi

All URIs are relative to */rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_jwt_issuer_settings**](#create_jwt_issuer_settings) | **post** /v1/config/jwtIssuer | Create JWT Issuer settings
[**delete_jwt_issuer_settings**](#delete_jwt_issuer_settings) | **delete** /v1/config/jwtIssuer/{name} | Delete JWT Issuer Settings
[**get_all_jwt_issuer_settings**](#get_all_jwt_issuer_settings) | **get** /v1/config/jwtIssuer | Get all JWT Issuer Settings
[**get_jwt_issuer_settings**](#get_jwt_issuer_settings) | **get** /v1/config/jwtIssuer/{name} | Get JWT Issuer settings
[**update_jwt_issuer_settings**](#update_jwt_issuer_settings) | **put** /v1/config/jwtIssuer | Update JWT Issuer settings

# **create_jwt_issuer_settings**
<a name="create_jwt_issuer_settings"></a>
> JWTIssuerSettings create_jwt_issuer_settings()

Create JWT Issuer settings

Create new JWT Issuer settings

### Example

```python
import openapi_client
from openapi_client.apis.tags import jwt_issuer_settings_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = jwt_issuer_settings_api.JWTIssuerSettingsApi(api_client)

    # example passing only optional values
    body = JWTIssuerSettings(
    ...
    try:
        # Create JWT Issuer settings
        api_response = api_instance.create_jwt_issuer_settings(
            body=body,
        )
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling JWTIssuerSettingsApi->create_jwt_issuer_settings: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
[**JWTIssuerSettings**](../../models/JWTIssuerSettings.md) |  | 
...
200 | [ApiResponseFor200](#create_jwt_issuer_settings.ApiResponseFor200) | successful operation

#### create_jwt_issuer_settings.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
# **delete_jwt_issuer_settings**
<a name="delete_jwt_issuer_settings"></a>
> JWTIssuerSettingsList delete_jwt_issuer_settings(name)

Delete JWT Issuer Settings

Delete existing JWT Issuer settings
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete JWT Issuer Settings
        api_response = api_instance.delete_jwt_issuer_settings(
            path_params=path_params,
        )
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling JWTIssuerSettingsApi->delete_jwt_issuer_settings: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#delete_jwt_issuer_settings.ApiResponseFor200) | successful operation

#### delete_jwt_issuer_settings.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
Type | Description  | Notes
------------- | ------------- | -------------
[**JWTIssuerSettingsList**](../../models/JWTIssuerSettingsList.md) |  | 
...
# **get_all_jwt_issuer_settings**
<a name="get_all_jwt_issuer_settings"></a>
> JWTIssuerSettingsList get_all_jwt_issuer_settings()

Get all JWT Issuer Settings

Get the list of all JWT Issuer Settings
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all JWT Issuer Settings
        api_response = api_instance.get_all_jwt_issuer_settings()
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling JWTIssuerSettingsApi->get_all_jwt_issuer_settings: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_all_jwt_issuer_settings.ApiResponseFor200) | successful operation

#### get_all_jwt_issuer_settings.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
# **get_jwt_issuer_settings**
<a name="get_jwt_issuer_settings"></a>
> JWTIssuerSettings get_jwt_issuer_settings(name)

Get JWT Issuer settings
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get JWT Issuer settings
        api_response = api_instance.get_jwt_issuer_settings(
            path_params=path_params,
        )
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling JWTIssuerSettingsApi->get_jwt_issuer_settings: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_jwt_issuer_settings.ApiResponseFor200) | successful operation

#### get_jwt_issuer_settings.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
# **update_jwt_issuer_settings**
<a name="update_jwt_issuer_settings"></a>
> JWTIssuerSettings update_jwt_issuer_settings()

Update JWT Issuer settings

Update existing JWT Issuer settings
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update JWT Issuer settings
        api_response = api_instance.update_jwt_issuer_settings(
            body=body,
        )
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling JWTIssuerSettingsApi->update_jwt_issuer_settings: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#update_jwt_issuer_settings.ApiResponseFor200) | successful operation

#### update_jwt_issuer_settings.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
