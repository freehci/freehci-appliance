...
/** Behold treff og alle forfedre, slik at hierarkiet fortsatt gir mening etter filter. */
export function filterPrefixesKeepingAncestors(
  all: Ipv4Prefix[],
  childrenByParentId: Map<number, Ipv4Prefix[]>,
  match: (p: Ipv4Prefix) => boolean,
): Ipv4Prefix[] {
