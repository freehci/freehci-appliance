...
export const nb = {
  ...
  "ipam.ipv4.intro":
    "Prefiks er unike per site: samme CIDR (f.eks. 192.168.1.0/24) kan finnes på flere sites. Listen er et tre: hvert prefiks ligger under den strammeste omsluttende forelderen på samme site (f.eks. to /25 under én /24). Bruk «del» for å opprette to /(n+1)-barn. Åpne Utforsk for adresser og skann. Utnyttelse teller plasserte adresser i CIDR (også ved kobling til smalere prefiks, f.eks. /32).",
