...
export const en = {
  ...
  "ipam.ipv4.intro":
    "Prefixes are unique per site: the same CIDR (e.g. 192.168.1.0/24) may exist at multiple sites. The list is a tree: each prefix nests under the tightest covering parent on that site (e.g. two /25 under a /24). Use “split” to create two /(n+1) children. Open Explore on a prefix for addresses and scans. Usage counts every placed device address inside the CIDR (including hosts linked to a more specific prefix such as /32).",
