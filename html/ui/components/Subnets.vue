<template>
    <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item" @click="selectTab('subnets')">
                <a class="nav-link" data-toggle="tab" href="#subnets" role="tab" :class="{ active: selectedTab === 'subnets' }"><i class="fas fa-network-wired"></i> Subnets</a>
            </li>
        ...
        <div class="tab-content">
            ...
            <!-- Networking -->
            <div id="subnets" class="tab-pane fade" :class="{ active: selectedTab === 'subnets', show: selectedTab === 'subnets' }">
                <h3>Subnets</h3>
                <p>Some content.</p>
            </div>
