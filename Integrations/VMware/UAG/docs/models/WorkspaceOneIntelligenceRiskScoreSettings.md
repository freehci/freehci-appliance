# openapi_client.model.workspace_one_intelligence_risk_score_settings.WorkspaceOneIntelligenceRiskScoreSettings
...
**workspaceOneIntelligenceSettingsName** | str,  | str,  |  | [optional] 
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
items | str,  | str,  |  | must be one of ["LOW", "MEDIUM", "HIGH", "OTHERS", ] 
