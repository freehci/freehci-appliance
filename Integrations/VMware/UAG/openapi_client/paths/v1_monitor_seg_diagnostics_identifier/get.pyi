...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'identifier': typing.Union[IdentifierSchema, list, tuple, ],
    }
)
...
SchemaFor200ResponseBodyApplicationZip = schemas.StrSchema
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_seg_diagnostic_stats_oapg(
        self,
...
class GetSegDiagnosticStats(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_seg_diagnostic_stats(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_seg_diagnostic_stats(
        ...
        return self._get_seg_diagnostic_stats_oapg(
