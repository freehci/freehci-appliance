...
class BaseApi(api_client.Api):
    @typing.overload
    def _upload_resource_associated_with_settings_oapg(
        self,
...
class UploadResourceAssociatedWithSettings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def upload_resource_associated_with_settings(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def upload_resource_associated_with_settings(
        ...
        return self._upload_resource_associated_with_settings_oapg(
