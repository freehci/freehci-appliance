...
SchemaFor200ResponseBodyApplicationJson = ResourceSettings
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_resource_settings_oapg(
        self,
...
class GetResourceSettings(BaseApi):
    ...
    def get_resource_settings(
        ...
        return self._get_resource_settings_oapg(
