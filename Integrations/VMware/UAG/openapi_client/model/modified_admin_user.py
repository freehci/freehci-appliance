...
class ModifiedAdminUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "password", "userId", "enabled", "roles", "adminPasswordSetTime", "noOfDaysRemainingForPwdExpiry", "userType", "adminMonitoringPasswordPreExpired", "modifiedBy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "password", "userId", "enabled", "roles", "adminPasswordSetTime", "noOfDaysRemainingForPwdExpiry", "userType", "adminMonitoringPasswordPreExpired", "modifiedBy", ], str]):
