...
class SpMediaTypes(
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SpMediaType']:
                        return SpMediaType
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SpMediaType'], typing.List['SpMediaType']],
                ...
                def __getitem__(self, i: int) -> 'SpMediaType':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["items", "_links", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["items", "_links", ], str]):
        return super().get_item_oapg(name)
