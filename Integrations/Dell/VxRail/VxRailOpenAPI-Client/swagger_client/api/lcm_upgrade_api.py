...
class LCMUpgradeApi(object):
    ...
    def vlcm_image_query(self, body, **kwargs):  # noqa: E501
        """vlcm_image_query  # noqa: E501

        Request to fetch the vLCM image information in the LCM bundle that is provided.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.vlcm_image_query(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.vlcm_image_query_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.vlcm_image_query_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def vlcm_image_query_with_http_info(self, body, **kwargs):  # noqa: E501
        """vlcm_image_query  # noqa: E501

        Request to fetch the vLCM image information in the LCM bundle that is provided.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.vlcm_image_query_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method vlcm_image_query" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `vlcm_image_query`")  # noqa: E501
